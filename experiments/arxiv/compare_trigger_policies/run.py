    ...
    21: Experiment(
        ...
        drift_detection_triggers={
            f"{criterion_name}_int{detection_interval}_win{window_size}": DataDriftTriggerConfig(
                ...
                sample_size=5_000,
                metrics={"mmd": AlibiDetectMmdDriftMetric(decision_criterion=criterion, device="cpu")},  # TODO: gpu?
            )
            ...
            for criterion_name, criterion in (
                {
                    ...
                    for quantile in [0.15, 0.3]  # TODO: 0.05, 0.10, 0.15, 0.3
                }
                # |
                # {
                ...
                #     )
                #     for deviation in [5.0, 0.2]  # TODO: 0.2, 5.0, - running 0.5, 1.0, 2.0
                # }
            ).items()
        },
        gpu_device="cuda:3",
