...
class TestStorage(unittest.TestCase):
    ...
    def test_create_shuffled_batch(self):
        ...
        test_file1 = STORAGE_LOCATION + '/tmp/test1.tar'
        test_file2 = STORAGE_LOCATION + '/tmp/test2.tar'
        test_file3 = STORAGE_LOCATION + '/tmp/test3.tar'
