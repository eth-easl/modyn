...
modyn-client --start-replay-at 0 --maximum-triggers 1 /scratch/sjohn/modyn/modynclient/config/examples/abstracts.yaml /scratch/sjohn/modyn/modynclient/config/examples/modyn_client_config.yaml
modyn-client --start-replay-at 0  /scratch/sjohn/modyn/modynclient/config/examples/abstracts.yaml /scratch/sjohn/modyn/modynclient/config/examples/modyn_client_config.yaml
