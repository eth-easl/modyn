...
def setup_argparser() -> argparse.ArgumentParser:
    ...
    parser_.add_argument("dir", type=pathlib.Path, action="store", help="Path to trained models directory")
    parser_.add_argument("output", type=pathlib.Path, action="store", help="Path to output json file")
    parser_.add_argument("evaluation_data", type=pathlib.Path, action="store", help="Path to evaluation data (day 23)")
