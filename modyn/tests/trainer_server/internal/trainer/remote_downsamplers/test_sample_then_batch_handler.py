...
def test_init_accumulation():
    ...
    with handler:
        handler.accumulate([1, 2, 3, 4], torch.Tensor([1, 2, 3, 4]), 0)
        handler.accumulate([11, 12, 13, 14], torch.Tensor([1, 2, 3, 4]), 1)
        handler.accumulate([21, 22, 23, 24], torch.Tensor([1, 2, 3, 4]), 2)
        handler.accumulate([31, 32, 33, 34], torch.Tensor([1, 2, 3, 4]), 3)
...
def test_skewed_distribution():
    ...
    with handler:
        handler.accumulate([1, 2, 3, 4], torch.Tensor([1, 2, 3, 4]), 0)
        handler.accumulate([11, 12, 13, 14], torch.Tensor([0, 0, 0, 0]), 1)
        handler.accumulate([21, 22, 23, 24], torch.Tensor([1, 2, 3, 4]), 2)
        handler.accumulate([31, 32, 33, 34], torch.Tensor([0, 0, 0, 0]), 3)
...
def test_restart_accumulation():
    ...
    with handler:
        ...
        assert not os.path.isdir(".tmp_scores")
        handler.accumulate([101, 102, 103, 104], torch.Tensor([10, 3, 3, 4]), 0)
        handler.accumulate([111, 112, 113, 114], torch.Tensor([10, 3, 3, 4]), 1)
        handler.accumulate([121, 122, 123, 124], torch.Tensor([10, 3, 3, 4]), 2)
