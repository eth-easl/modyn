...
def test_get_eval_intervals() -> None:
    ...
    eval_strategy = _IntervalEvalStrategy(_IntervalEvalStrategyConfig(interval="[-inf,-0d]"))
    ...
    eval_strategy = _IntervalEvalStrategy(_IntervalEvalStrategyConfig(interval="(+0s, +inf]"))
    ...
    eval_strategy = _IntervalEvalStrategy(_IntervalEvalStrategyConfig(interval="[-0d, +0d]"))
    assert list(eval_strategy.get_eval_intervals(0, 0)) == [(0, 0)]
    ...
    eval_strategy = _IntervalEvalStrategy(_IntervalEvalStrategyConfig(interval="(+0s, +100s]"))
    ...
    eval_strategy = _IntervalEvalStrategy(_IntervalEvalStrategyConfig(interval="[-100s, -0s]"))
    assert list(eval_strategy.get_eval_intervals(0, 0)) == [(0, 0)]
    assert list(eval_strategy.get_eval_intervals(40, 70)) == [(0, 40)]
    assert list(eval_strategy.get_eval_intervals(100, 100)) == [(0, 100)]
    assert list(eval_strategy.get_eval_intervals(130, 200)) == [(30, 130)]

    eval_strategy = _IntervalEvalStrategy(_IntervalEvalStrategyConfig(interval="(-15s, -10s)"))
