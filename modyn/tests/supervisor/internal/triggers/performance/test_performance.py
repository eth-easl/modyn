...
def test_forecast_expected_performance_simple_average() -> None:
    ...
    tracker.inform_trigger(10, 2, 0.8)
    tracker.inform_trigger(20, 3, 0.85)
    performance = tracker.forecast_expected_performance("rolling_average")
    assert performance == 0.825  # Simple average of 0.8 and 0.85
    performance = tracker.forecast_expected_performance("ridge_regression")
...
def test_forecast_expected_performance_ridge_regression() -> None:
    ...
    tracker.inform_trigger(20, 3, 0.85)
    tracker.inform_trigger(10, 1, 0.9)
    tracker.inform_trigger(20, 1, 0.95)
    tracker.inform_trigger(10, 0, 1.0)
    tracker.inform_trigger(20, 0, 1.0)
    performance = tracker.forecast_expected_performance("rolling_average")
    assert isinstance(performance, float)  # Should run ridge regression
    assert performance == (0.85 + 0.9 + 0.95 + 1.0 + 1.0) / 5
    performance_ridge = tracker.forecast_expected_performance("ridge_regression")
...
def test_forecast_next_performance_simple_average() -> None:
    tracker = PerformanceTracker(trigger_eval_window_size=3)
    tracker.inform_evaluation(10, 2, 0.8)
    tracker.inform_evaluation(20, 3, 0.85)
    performance = tracker.forecast_next_performance("rolling_average")
    assert performance == 0.825  # Simple average of 0.8 and 0.85


def test_forecast_next_performance_ridge_regression() -> None:
    tracker = PerformanceTracker(trigger_eval_window_size=5)
    tracker.inform_evaluation(10, 1, 0.8)
    tracker.inform_evaluation(10, 1, 0.85)
    tracker.inform_evaluation(10, 1, 0.9)
    tracker.inform_evaluation(10, 1, 0.95)
    tracker.inform_evaluation(10, 1, 1.0)
...
def test_forecast_next_performance_with_no_evaluations() -> None:
    tracker = PerformanceTracker(trigger_eval_window_size=3)
    tracker.inform_trigger(10, 1, 0.8)
    tracker.inform_trigger(10, 1, 0.85)
    performance = tracker.forecast_next_performance()
    assert isinstance(performance, float)
...
def test_accuracy_forecasts() -> None:
    ...
    tracker.inform_evaluation(10, 1, 0)
    tracker.inform_evaluation(10, 2, 0)
    tracker.inform_evaluation(10, 3, 0)
    tracker.inform_evaluation(10, 4, 0)
    tracker.inform_evaluation(10, 5, 0)
    performance = tracker.forecast_next_accuracy("rolling_average")
    assert performance == (9 + 8 + 7 + 6 + 5) / 5 / 10

    tracker.inform_trigger(10, 1, 0)
    tracker.inform_trigger(10, 2, 0)
    tracker.inform_trigger(10, 3, 0)
    tracker.inform_trigger(10, 4, 0)
    tracker.inform_trigger(10, 5, 0)
