...
def test_metric_availability():
    ...
    f1_score = MetricFactory.get_evaluation_metric("F1Score", config={"num_classes": 10}, evaluation_transform_func="")
    auc_roc = MetricFactory.get_evaluation_metric("RocAuc", config={}, evaluation_transform_func="")
