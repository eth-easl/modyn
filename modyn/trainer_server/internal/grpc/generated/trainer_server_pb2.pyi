...
class RegisterTrainServerRequest(google.protobuf.message.Message):
    ...
    def HasField(
        ...
        field_name: typing_extensions.Literal[
            ...
            b"data_info",
            "model_configuration",
            b"model_configuration",
            "optimizer_parameters",
            b"optimizer_parameters",
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class Data(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, dataset_id: builtins.str = ..., num_dataloaders: builtins.int = ...
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "dataset_id", b"dataset_id", "num_dataloaders", b"num_dataloaders"
        ],
    ) -> None: ...
...
class TrainerAvailableResponse(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["available", b"available"]
    ) -> None: ...
...
class StartTrainingRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        ...
        field_name: typing_extensions.Literal[
            ...
            b"load_checkpoint_path",
            "train_until_sample_id",
            b"train_until_sample_id",
            "training_id",
            b"training_id",
        ],
    ) -> None: ...
...
class StartTrainingResponse(google.protobuf.message.Message):
    ...
    def __init__(self, *, training_started: builtins.bool = ...) -> None: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal["training_started", b"training_started"],
    ) -> None: ...
...
class TrainingStatusRequest(google.protobuf.message.Message):
    ...
    TRAINING_ID_FIELD_NUMBER: builtins.int
    training_id: builtins.int
    def __init__(self, *, training_id: builtins.int = ...) -> None: ...
    def ClearField(
...
class TrainingStatusResponse(google.protobuf.message.Message):
    ...
    ) -> typing_extensions.Literal["state"] | None: ...
