...
class StartTrainingRequest(google.protobuf.message.Message):
    ...
    PREFETCHED_PARTITIONS_FIELD_NUMBER: builtins.int
    ...
    prefetched_partitions: builtins.int
    seed: builtins.int
    @property
