...
class MetadataCollector:
    ...
    def add_per_sample_metadata_for_batch(self, metric: str, sample_id_list: list[str], metadata_list: list[Any]):
    ...
    def add_per_trigger_metadata(self, metric: str, metadata: Any):
    ...
    def send_metadata(self):
        ...
        for metric in self._per_trigger_metadata:

            metadata_request = TrainingMetadataRequest(
                pipeline_id=self._pipeline_id,
                trigger_id=self._trigger_id,
                per_tigger_metadata=self._per_trigger_metadata[metric]
            )
