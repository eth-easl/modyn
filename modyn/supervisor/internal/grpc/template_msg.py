...
def pipeline_res_msg(pipeline_id: int = -1, exception: str | None = None) -> dict[str, Any]:
...
def pipeline_stage_msg(
    stage: PipelineStage, msg_type: MsgType, submsg: dict[str, Any] | None = None, log: bool = False
) -> dict[str, Any]:
...
def counter_submsg(action: CounterAction, params: dict[str, Any] | None = None) -> dict[str, Any]:
...
def exit_submsg(exitcode: int, exception: str | None = None) -> dict[str, Any]:
