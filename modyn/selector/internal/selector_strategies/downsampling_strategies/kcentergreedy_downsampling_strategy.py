from modyn.config.schema.pipeline_component.sampling.downsampling_config import KcenterGreedyDownsamplingConfig
...
class KcenterGreedyDownsamplingStrategy(AbstractDownsamplingStrategy):
    def __init__(
        self,
        downsampling_config: KcenterGreedyDownsamplingConfig,
        modyn_config: dict,
        pipeline_id: int,
