...
static std::shared_ptr<storage::file_wrapper::FileWrapper> get_file_wrapper(
  ...
  std::shared_ptr<storage::file_wrapper::FileWrapper> file_wrapper;
  if (type == storage::file_wrapper::FileWrapperType::BINARY) {
    file_wrapper =
        std::make_shared<storage::file_wrapper::BinaryFileWrapper>(path, file_wrapper_config, filesystem_wrapper);
  } else if (type == storage::file_wrapper::FileWrapperType::SINGLE_SAMPLE) {
    file_wrapper =
        std::make_shared<storage::file_wrapper::SingleSampleFileWrapper>(path, file_wrapper_config, filesystem_wrapper);
  } else {
