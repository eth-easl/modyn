#!/bin/bash
exec python ./modyn/backend/newqueue/newqueue_server.py ./modyn/config/config.yaml &
...
exec python ./modyn/backend/newqueue/newqueue_poller.py ./modyn/config/config.yaml
