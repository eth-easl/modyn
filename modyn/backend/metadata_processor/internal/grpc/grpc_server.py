...
from modyn.backend.metadata_processor.internal.grpc.metadata_processor_pb2_grpc import add_MetadataProcessorServicer_to_server
...
class GRPCServer():
	...
	def __enter__(self) -> grpc.Server:
		...
		add_MetadataProcessorServicer_to_server(
			MetadataProcessorGRPCServicer(self.config), self.server)
