...
from modyn.backend.metadata_processor.internal.mocks.mocks_metadata_database import SetRequest
...
class BasicProcessorStrategy(MetadataProcessorStrategy):
    ...
    def process__metadata(self, training_id: int, data: str) -> SetRequest:
