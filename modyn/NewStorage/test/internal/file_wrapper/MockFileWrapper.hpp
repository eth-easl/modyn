...
public:
  ...
  MOCK_METHOD(std::vector<std::vector<unsigned char>> *, get_samples,
              (int start, int end), (override));
  MOCK_METHOD(int, get_label, (int index), (override));
  MOCK_METHOD(std::vector<int> *, get_all_labels, (), (override));
  MOCK_METHOD(std::vector<unsigned char> *, get_sample, (int index),
              (override));
  MOCK_METHOD(std::vector<std::vector<unsigned char>> *,
