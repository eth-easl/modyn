# Info
This folder contains the implementation of a DLRM.
We use the implementation provided by the NVIDIA [repository](https://github.com/NVIDIA/DeepLearningExamples/tree/master/PyTorch/Recommendation/DLRM)

# Changes to NVIDIA Version
In according with the LICENSE of the NVIDIA code, we list our changes here:
- We remove CUDA graphs
