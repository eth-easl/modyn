...
setup(
    ext_modules=[
          CUDAExtension(name="cuda_ext.fused_embedding",
                        sources=[
          ...
          CUDAExtension(name="cuda_ext.interaction_volta",
                        sources=[
          ...
          CUDAExtension(name="cuda_ext.interaction_ampere",
                        sources=[
          ...
          CUDAExtension(name="cuda_ext.sparse_gather",
                        sources=[
