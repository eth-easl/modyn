...
class EvaluateModelRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_tokenizer", b"_tokenizer", "_trigger_training_set_info", b"_trigger_training_set_info", "bytes_parser", b"bytes_parser", "dataset_info", b"dataset_info", "label_transformer", b"label_transformer", "tokenizer", b"tokenizer", "trigger_training_set_info", b"trigger_training_set_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_tokenizer", b"_tokenizer", "_trigger_training_set_info", b"_trigger_training_set_info", "batch_size", b"batch_size", "bytes_parser", b"bytes_parser", "dataset_info", b"dataset_info", "device", b"device", "label_transformer", b"label_transformer", "metrics", b"metrics", "model_id", b"model_id", "tokenizer", b"tokenizer", "transform_list", b"transform_list", "trigger_training_set_info", b"trigger_training_set_info"]) -> None: ...
    @typing.overload
