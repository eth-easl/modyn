...
class DatasetInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["dataset_id", b"dataset_id", "end_timestamp", b"end_timestamp", "num_dataloaders", b"num_dataloaders", "start_timestamp", b"start_timestamp"]) -> None: ...
